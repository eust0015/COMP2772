        ...
        <form id='payment-form' name='paymentDetails' class='payment-form' action="confirmation.php" method="POST">
            ...
            <div name='paymentDetails'>
                <ul class='paymentDetails'>
                    <li><label id='name-on-card' for='name-on-card'>Name On Card: </label><input type='name' id='name-on-card' name='nameOnCard' placeholder='Required' required value='<?php echo (isset($_SESSION["account"]["name-on-card"]) ? $_SESSION["account"]["name-on-card"] : ""); ?>' required value></li>
                    <li><label id='card-number' for='card-number'>Card Number: </label><input type='text' id='card-number' name='cardNumber' placeholder='Required' required value='<?php echo (isset($_SESSION["account"]["card-number"]) ? $_SESSION["account"]["card-number"] : ""); ?>'required value></li>
                    <li><label id='expiration-month' for='expiration-month'>Expiration Month: </label><input type='text' id='expiration-month' name='expirationMonth' placeholder='Required' required required value></li>
                    <li><label id='expiration-year' for='expiration-year'>Expiration Year: </label><input type='text' id='expiration-year' name='expirationYear' placeholder='Required' required required value></li>
